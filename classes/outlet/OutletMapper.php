...
class OutletMapper {
    ...
    private static function saveManyToMany ($obj) {
    ...
    private static function saveManyToOne ($obj) {
        $conf = self::getConfig($obj);
	 ...
	 * @return boolean
	 */
    public static function getModifiedFields ($obj) {
     ...
     */
    static function get ( $clazz, array $pk ) {
        // FIXME: Library should handle PK updates
